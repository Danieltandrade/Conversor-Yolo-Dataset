...
def create_output_dir():
    ...
    if not os.path.exists(output_dir):
        ...
        train_images_dir = os.path.join(output_dir, "dataset/images/train")
        val_images_dir = os.path.join(output_dir, "dataset/images/val")
        train_labels_dir = os.path.join(output_dir, "dataset/labels/train")
        val_labels_dir = os.path.join(output_dir, "dataset/labels/val")
        os.makedirs(train_images_dir, exist_ok=True)
        os.makedirs(val_images_dir, exist_ok=True)
        os.makedirs(train_labels_dir, exist_ok=True)
        os.makedirs(val_labels_dir, exist_ok=True)

    return output_dir, train_images_dir, val_images_dir, train_labels_dir, val_labels_dir
